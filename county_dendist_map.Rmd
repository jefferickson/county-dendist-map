...
county.city.list.shortest <- sqldf("select county_geo_id, SUBHD0401, HD01, min(dist) as dist, min(driving_distance) as driving_dist from `county.city.list.long` group by county_geo_id")
